...
//Subclass
public class Skincare extends fashion{
    Scanner input  = new Scanner(System.in);
    int pilih;
    //Constructor
   public Skincare(String Produk1, String Produk2, String Produk3){
    //Penggunaan Super
    super (Produk1, Produk2, Produk3);
    }
    public void Kategori_Skincare(){
    System.out.println("_____________  Skincare __________________");
    System.out.println("1. "+Produk1+ " ~ Rp 60000");
    System.out.println("2. "+Produk2+ " ~ Rp 50000");
    System.out.println("3. "+Produk3+ " ~ Rp 40000");
