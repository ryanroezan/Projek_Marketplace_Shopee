...
//Subclass
public class Elektronik extends fashion{
    //Constructor
    public Elektronik(String Produk1, String Produk2, String Produk3){
        //Penggunaan Super
        super (Produk1, Produk2, Produk3);
    }
public void Kategori_elektronik(){
    Scanner input  = new Scanner(System.in);
    int pilih;
    System.out.println("_____________  Elektronik 100% ori __________________");
    System.out.println("1. " +Produk1+" ~ Rp 1900000");
    System.out.println("2. " +Produk2+" ~ Rp 12000000");
    System.out.println("3. " +Produk3+" ~ Rp 17500000");
