...
public class fashion {
    ...
    protected int harga,jumlahProduk,voucherGratisOngkir=5,voucherdiskon=3, pakai;
    public int SubtotalPengiriman, DiskonPengiriman, voucherDiskon, voucherCashback;
    public  String penerima,alamat,pos,tlpn, jasaKirim, EstimasiSampai;
    Scanner x = new Scanner(System.in);
     String Produk1, Produk2, Produk3;
     //Constructor
    public fashion(String Produk1, String Produk2, String Produk3){
        //penggunaan this
        this.Produk1=Produk1;
        this.Produk2=Produk2;
        this.Produk3=Produk3;
    }
//Method    
public void Kategori_Fashion(){
    int pilih;
    System.out.println("___________________  Fashion  ______________________");
    System.out.println("1. " +Produk1+ " ~ Rp 150000");
    System.out.println("2. " +Produk2+ " ~ Rp 120000");
    System.out.println("3. " +Produk3+ " ~ Rp 250000");
