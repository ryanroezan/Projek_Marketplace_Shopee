...
//Subclass
public class ShopeeFood extends fashion {
    //Constructor
    public ShopeeFood(String Produk1, String Produk2, String Produk3){
    //Penggunaan Super
    super (Produk1, Produk2, Produk3);
    Scanner input = new Scanner(System.in);
    }
public void Kategori_ShopeeFood(){
System.out.println("__________________  Shopee Food  _____________________");
System.out.println("1. "+Produk1+ " ~ Rp 50000");
System.out.println("2. "+Produk2+ " ~ Rp 25000");
System.out.println("3. "+Produk3+ " ~ Rp 12000");
